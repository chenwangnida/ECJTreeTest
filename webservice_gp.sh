...
java -classpath ./bin:.:jgraph-5.13.0.0.jar:jgrapht-core-1.0.1.jar:guava-20.0.jar:ecj.23.jar ec.Evolve  -file wsc.params -p composition-services=services-output.xml -p composition-task=problem.xml -p composition-taxonomy=taxonomy.owl -p seed.0=$seed
